...
if (isset($_POST['submit'])) {
    ...
    $dir = "../assets/img/makeupimages/";
    if (!is_dir($dir)) {
        mkdir("../assets/img/makeupimages/");
    }

    move_uploaded_file($_FILES["gambar"]["tmp_name"], "../assets/img/makeupimages/" . $_FILES["gambar"]["name"]);
    $sql = mysqli_query($db_connection, "insert into services(kategori,harga,gambar) values('$services','$harga','$gambar')");
    $_SESSION['msg'] = "menambah data";
}
?>
                ...
                <section class="section">
                    ...
                    <div class="section-body">
                        <?php if (isset($_POST['submit'])) { ?>
                            <div class="alert alert-success col-md-4 mt-4">
